...
extern const uint16_t emo_normal_f1[EMO_PIXEL_COUNT];
extern const uint16_t emo_normal_f2[EMO_PIXEL_COUNT];
...
extern const uint16_t emo_focus_f2[EMO_PIXEL_COUNT];
extern const uint16_t emo_angry_f0[EMO_PIXEL_COUNT];
extern const uint16_t emo_angry_f1[EMO_PIXEL_COUNT];
extern const uint16_t emo_angry_f2[EMO_PIXEL_COUNT];
extern const uint16_t emo_sleep_f0[EMO_PIXEL_COUNT];
extern const uint16_t emo_sleep_f1[EMO_PIXEL_COUNT];
extern const uint16_t emo_sleep_f2[EMO_PIXEL_COUNT];
extern const uint16_t emo_surprise_f0[EMO_PIXEL_COUNT];
extern const uint16_t emo_surprise_f1[EMO_PIXEL_COUNT];
extern const uint16_t emo_surprise_f2[EMO_PIXEL_COUNT];
extern const uint16_t emo_sad_f0[EMO_PIXEL_COUNT];
extern const uint16_t emo_sad_f1[EMO_PIXEL_COUNT];
extern const uint16_t emo_sad_f2[EMO_PIXEL_COUNT];
extern const uint16_t emo_love_f0[EMO_PIXEL_COUNT];
extern const uint16_t emo_love_f1[EMO_PIXEL_COUNT];
extern const uint16_t emo_love_f2[EMO_PIXEL_COUNT];
